...
class PdfBorders(SpireObject):
    ...
    @dispatch
    def __init__(self):
        GetDllLibPdf().PdfBorders_CreatePdfBorders.restype = c_void_p
        intPtr = CallCFunction(GetDllLibPdf().PdfBorders_CreatePdfBorders)
        super(PdfBorders, self).__init__(intPtr)
    @property
